import { CreatePillsBody, PillsResponse } from '../types/pills.types';

/**
 * Pills Factory
 * 
 * Generates test data for Pills domain tests.
 */
export class PillsFactory {
  /**
   * Creates a valid pills payload
   */
  ...
  /**
   * Creates an empty pills payload
   */
  ...
  /**
   * Creates a valid body for creating pills
   */
